...
public class B19_TestXLSX  {
	...
	@Test
	  public void XLSX() throws Exception {
		    ...
		    // File src = new File("C:\\Users\\Admin\\OneDrive\\Desktop\\Power.xlsx");
		      // File F   = new File ("C:\\Users\\Admin\\OneDrive\\Desktop\\Power.xlsx");
		       
		      
		     // Load the file
		     FileInputStream finput = new FileInputStream("C:\\Users\\Admin\\OneDrive\\Desktop\\Power.xlsx");
		    ...
		    XSSFWorkbook workbook = new XSSFWorkbook(finput);
		     ...
		     XSSFSheet s = workbook.getSheetAt(0); //here getsheetAt(0); is index value means excel sheet name Gama index value is 0.if you take 1st index value then you will take 2n sheet name.
